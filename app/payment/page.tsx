    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_50%_0%,_rgba(82,200,120,0.10),_transparent_35%)] px-5 py-20 md:px-8 md:py-28">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-10 text-center md:mb-12">
          ...
          <p className="mx-auto mt-4 max-w-xl leading-relaxed text-muted-foreground">Choose your book, enter the amount, then continue to Pesapal to complete your payment securely.</p>
        </div>
        <form onSubmit={handlePayment} className="rounded-[2rem] border border-border bg-card/95 p-7 shadow-2xl shadow-forest/10 backdrop-blur md:p-10">
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-2"><label htmlFor="amount" className="text-sm font-medium text-forest">Amount (RWF)</label><input id="amount" type="number" min="1" step="1" required value={form.amount} onChange={e=>updateField('amount',e.target.value)} placeholder="Enter amount" disabled={loading} className="rounded-xl border border-border bg-background px-4 py-3 font-semibold text-foreground outline-none focus:border-emerald focus:ring-2 focus:ring-emerald/30" /></div>
