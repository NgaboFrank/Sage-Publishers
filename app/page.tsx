...
const bookJsonLd = {
  '@context': 'https://schema.org', '@type': 'Book', name: 'The Breeze of the Forest',
  description: 'A collection of entertaining and educational animal tales for children that inspire bravery, courage, kindness, friendship and imagination.',
  url: 'https://sagepublishersltd.com', image: 'https://sagepublishersltd.com/book-cover.jpeg',
  publisher: { '@type': 'Organization', name: 'Sage Publishers Ltd', url: 'https://sagepublishersltd.com' },
  genre: ["Children's literature", 'Animal stories', 'Educational stories'], inLanguage: 'en',
}
const faqJsonLd = {
