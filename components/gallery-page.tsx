...
const items: GalleryItem[] = [
  ...
  {
    src: '/gallery/illustration-1.jpg',
    alt: 'Shepherd with goats gathered around a tent',
    span: 'sm:col-span-2',
  },
  {
    src: '/gallery/illustration-2.jpg',
    alt: 'Rhino in landscape with mountain and forest',
    span: 'sm:col-span-2 sm:row-span-2',
  },
  {
    src: '/gallery/illustration-3.jpg',
    alt: 'Forest scene with birds, animals and nature',
    span: '',
  },
  {
    src: '/gallery/illustration-4.jpg',
    alt: 'Two birds on a branch with hippopotamus and crocodile in forest',
    span: 'sm:col-span-2',
  },
  {
    src: '/gallery/illustration-6.jpg',
    alt: 'Heron and crocodile at water with nature',
    span: '',
  },
  {
    src: '/gallery/illustration-7.jpg',
    alt: 'Heron and crocodile in natural setting',
    span: '',
  },
  {
    src: '/gallery/illustration-8.jpg',
    alt: 'Bird on pole with hanging birdcages',
    span: 'sm:col-span-2',
  },
  {
    src: '/gallery/illustration-9.jpg',
    alt: 'Man in traditional clothing with goats and tent',
    span: '',
  },
  {
    src: '/gallery/illustration-10.jpg',
    alt: 'Snake and birds with clouds and rain',
    span: 'sm:col-span-2',
  },
  {
    src: '/gallery/illustration-11.jpg',
    alt: 'Person with fruits and shepherd with goats and tent',
    span: 'sm:col-span-2 sm:row-span-2',
  },
  {
    src: '/gallery/illustration-12.jpg',
    alt: 'Goat and deer in forest with pine trees',
    span: 'sm:col-span-2',
  },
  {
    src: '/gallery/illustration-13.jpg',
    alt: 'Two camels in pastoral landscape with tent',
    span: '',
  },
]
        ...
        <div className="mx-auto max-w-2xl text-center">
          <Reveal>
            ...
            <p className="mt-4 text-pretty leading-relaxed text-muted-foreground">
              Explore the hand-painted world and beautiful illustrations from The Breeze of the Forest.
            </p>
          </Reveal>
        </div>
